...
m = ModelOutput('/storage/home/hcoda1/7/shardin31/p-jw254-0/Research/summer2023/pd_test/run_1000000/example.0000.rtout.image')
...
fig.savefig('pd_image_1000000.png', bbox_inches='tight', dpi=150)


#f.create_dataset('halo_0/1000000/image', data=final_image_log)
