...
run_1mil = '/storage/home/hcoda1/7/shardin31/p-jw254-0/Research/summer2023/pd_test/run_1000000/halo_57/example.0057.rtout.sed'
run_10mil = '/storage/home/hcoda1/7/shardin31/p-jw254-0/Research/summer2023/pd_test/run_10000000_1angle/halo_57/example.0057.rtout.sed'
...
m_10mil = ModelOutput(run_10mil)
wav_10mil,flux_10mil = m_10mil.get_sed(inclination=0,aperture=-1)

flux_10mil = np.asarray(flux_10mil)*u.erg/u.s

flux_10mil /= (4.*3.14*dl**2.)

flux_10mil /= nu
flux_10mil = flux_10mil.to(u.mJy)


flux_diff = flux_10mil - flux_1mil

frac_diff = flux_diff/flux_10mil

filtered_diff = frac_diff[~np.isnan(frac_diff)]

with open('halo_57_differences.txt', 'a') as file:
...
ax.set_ylabel('Fractional Difference (mJy)')
#ax.set_ylim([1,1e8])
#ax.set_xlim(0.05,15000)
ax.grid()

fig.savefig('/storage/home/hcoda1/7/shardin31/p-jw254-0/Research/summer2023/pd_test/run_10000000_1angle/pd_sed/sed_compare_frac_diff_halo_57.png')
