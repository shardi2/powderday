...
zoom_box_len = float(a["virial_radius"][99].to("kpc")*a["scale"][99])# kpc; so the box will be +/- zoom_box_len from the center
...
#RT INFORMATION
#===============================================
n_photons_initial = 10000000
n_photons_imaging = 10000000
n_photons_raytracing_sources = 10000000
n_photons_raytracing_dust = 10000000
n_photons_DIG = 10000000
