...
PD_output_dir = '/storage/home/hcoda1/7/shardin31/p-jw254-0/Research/summer2023/pd_test/run_10000000_1angle/halo_2'
...
x_cent = float(a["position"][2][0])
y_cent = float(a["position"][2][1])
z_cent = float(a["position"][2][2])
