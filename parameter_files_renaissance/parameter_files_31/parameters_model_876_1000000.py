...
PD_output_dir = '/storage/home/hcoda1/7/shardin31/p-jw254-0/Research/summer2023/pd_test/run_renaissance_1000000/halo_1850/'
...
x_cent = float(a["position"][1850][0])
y_cent = float(a["position"][1850][1])
z_cent = float(a["position"][1850][2])
