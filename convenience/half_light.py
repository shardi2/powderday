...
fig.savefig('half_light_check.png')

print("half light kpc:", kpc_half_light_rad)

if 'halo_0/photons_1e4/half_light_rad' in f:
    del f['halo_0/photons_1e4/half_light_rad']
    f.attrs['halo_0/photons_1e4/half_light_rad'] = kpc_half_light_rad
else:
    f.attrs['halo_0/photons_1e4/half_light_rad'] = kpc_half_light_rad
