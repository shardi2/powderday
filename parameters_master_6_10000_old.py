...
zoom_box_len = float(a[32]["prog", "virial_radius"][34].to("kpc")*a[32]["prog", "scale"][34])
# kpc; so the box will be +/- zoom_box_len from the center
...
#RT INFORMATION
#===============================================
n_photons_initial = 10000
n_photons_imaging = 10000
n_photons_raytracing_sources = 10000
n_photons_raytracing_dust = 10000
n_photons_DIG = 10000
