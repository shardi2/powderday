...
m_1mil = ModelOutput('/storage/home/hcoda1/7/shardin31/p-jw254-0/Research/summer2023/pd_test/run_3000000/halo_49/example.0049.rtout.image')
m_100 = ModelOutput('/storage/home/hcoda1/7/shardin31/p-jw254-0/Research/summer2023/pd_test/run_300000/halo_49/example.0049.rtout.image')
...
image_100 = m_100.get_image(units='ergs/s')
...
image_diff = (image_1mil.val[0, :, :, iwav]) - (image_100.val[0, :, :, iwav])

frac_diff = image_diff / image_1mil.val[0, :, :, iwav].mean()
...
print("difference in total luminosities:", (image_1mil.val[0, :, :, iwav]).sum() - (image_100.val[0, :, :, iwav]).sum())
...
plt.colorbar(cax, label='Luminosity (ergs/s)')

fig.savefig('/storage/home/hcoda1/7/shardin31/p-jw254-0/Research/summer2023/pd_test/run_3000000/pd_image/pd_image_compare_diff_halo_49.png', bbox_inches='tight', dpi=150)
