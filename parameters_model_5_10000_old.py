...
hydro_dir = '/storage/home/hcoda1/0/jw254/data/SG64-2020/DD0090/'
...
PD_output_dir = '/storage/home/hcoda1/7/shardin31/p-jw254-0/Research/summer2023/pd_test/run_10000_old'
...
x_cent = float(a[15]["prog", "position"][34][0])
y_cent = float(a[15]["prog", "position"][34][1])
z_cent = float(a[15]["prog", "position"][34][2])
